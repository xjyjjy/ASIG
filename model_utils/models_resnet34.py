...
class PHDnet_resNet(nn.Module):
    def __init__(self):
        ...
        self.resblock_enc1_1 = ResBlock_enc(64, 64)
        self.resblock_enc1_2 = ResBlock_enc(64, 64)
        self.resblock_enc1_3 = ResBlock_enc(64, 64)


        self.resblock_enc2_1 = ResBlock_enc_pooling(64,128)
        self.resblock_enc2_2 = ResBlock_enc(128,128)
        self.resblock_enc2_3 = ResBlock_enc(128,128)
        self.resblock_enc2_4 = ResBlock_enc(128,128)

        self.resblock_enc3_1 = ResBlock_enc_pooling(128,256)
        self.resblock_enc3_2 = ResBlock_enc(256,256)
        self.resblock_enc3_3 = ResBlock_enc(256,256)
        self.resblock_enc3_4 = ResBlock_enc(256,256)
        self.resblock_enc3_5 = ResBlock_enc(256,256)
        self.resblock_enc3_6 = ResBlock_enc(256,256)


        self.resblock_enc4_1 = ResBlock_enc_pooling(256,512)
        self.resblock_enc4_2 = ResBlock_enc(512,512)
        self.resblock_enc4_3 = ResBlock_enc(512,512)

        self.resblock_dec1 = ResBlock_dec(512, 256)
