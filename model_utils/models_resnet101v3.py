'''
models_resnet101v2.py

add skip connection
add stride
change decoder channel #
Final decoder kernel change to 1
...
from model_utils.convolution_combine_stride import PHDConv2d
...
class PHDnet_resNet(nn.Module):
    def __init__(self):
        ...
        self.resblock_dec1 = ResBlock_dec(2048, 1024)
        self.resblock_dec2 = ResBlock_dec(1024,512)
        self.resblock_dec3 = ResBlock_dec(512,256)
        self.resblock_dec4 = ResBlock_dec(256,128)
        self.resblock_dec5 = ResBlock_dec(128,64)
        self.resblock_dec6 = ResBlock_dec(64, 13, Final = True)
    ...
    def forward(self, input, level):       #input.size = [batch* 5, c, h ,w]  level=7
        ...
        x0 = self.resblock_dec6(x0, level)
...
class InitialBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv2 = PHDConv2d(in_channels=out_channels, out_channels=out_channels,stride=2)
